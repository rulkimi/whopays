...
def upgrade() -> None:
    """Upgrade schema."""
    # Add friend table without duplicate index creation that could fail if index exists elsewhere
    op.create_table(
        'friend',
        ...
        # Remove index=True from status column to prevent auto-indexing
    ...
    # Use op.f() for the friend status index name for idempotency, matching alembic conventions
